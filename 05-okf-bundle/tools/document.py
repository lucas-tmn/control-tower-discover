"""OKF document parser and serializer.

Adapted from the Google OKF reference-agent bundle/document.py.
Parses and serializes markdown files with YAML frontmatter following the OKF spec.
"""
